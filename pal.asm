...
Msg     db      cr,lf,' . DOSTHEME:Loading SOLARISED 0.1',cr,lf,' . github.com/dmitrygerasimuk/dos-theme',cr,lf,'$'
Begin:

        setColor 0,0x00,0x09,0x10 ; base0 black
	setColor 1,0x01,0x20,0xaf ; blue
	setColor 2,0xaa,0xfe,0x00 ; green
	setColor 3,0x0a,0xeb,0xef ; cyan
	setColor 7,0xee,0xee,0xee ; base white
